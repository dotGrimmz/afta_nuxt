...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      bingo_event_participants: {
        Row: {
          id: string;
          event_id: string;
          user_id: string | null;
          card_amount: number;
          free_space_enabled: boolean;
          auto_mark_enabled: boolean;
        ...
        Insert: {
          ...
          free_space_enabled?: boolean;
          auto_mark_enabled?: boolean;
          status?: "pending" | "partial" | "paid"; // defaults to "pending" if omitted
          joined_at?: string;
        };
        Update: {
          id?: string;
        ...
        Relationships: [
          {
            foreignKeyName: "bingo_event_participants_event_id_fkey";
            columns: ["event_id"];
            isOneToOne: false;
      ...
      bingo_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "bingo_events_game_id_fkey";
            columns: ["game_id"];
            isOneToOne: true;
            referencedRelation: "bingo_games";
            referencedColumns: ["id"];
